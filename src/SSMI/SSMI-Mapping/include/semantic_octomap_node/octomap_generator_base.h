...
public:
    ...
    virtual void setDynamicFreeUpdates(int updates) = 0;

    /// Consecutive ray-confirmed free scans required before accelerated clear.
    virtual void setDynamicFreeConfirmations(int confirmations) = 0;
